...
import com.assoc.events.EventsFragment;
...
public class MyHome extends Fragment implements OnTabChangeListener,
	...
	private void initializeTabHost(Bundle args) {
		...
		tabHost.setup();
			...
			tabSpec = tabHost.newTabSpec("Nos Services");
			tabSpec.setIndicator("Nos Services");
			tabSpec.setContent(new FakeContent(getActivity()));
			tabHost.addTab(tabSpec);
			
			tabSpec = tabHost.newTabSpec("Événements");
			tabSpec.setIndicator("Événements");
			tabSpec.setContent(new FakeContent(getActivity()));
			tabHost.addTab(tabSpec);
